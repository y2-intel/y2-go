...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("Y2_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("Y2_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("Y2_CUSTOM_HEADERS"); ok {
...
// environment (Y2_API_KEY, Y2_BASE_URL). The option passed in as arguments are
