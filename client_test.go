...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Reports.List(context.Background(), y2.ReportListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Reports.List(cancelCtx, y2.ReportListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Reports.List(deadlineCtx, y2.ReportListParams{})
		if err == nil {
